System.register(["angular2/src/facade/lang", "angular2/src/facade/async", "angular2/src/facade/collection", "angular2/src/facade/dom", "angular2/change_detection", "./directive_metadata_reader", "./view", "./pipeline/compile_pipeline", "./pipeline/compile_element", "./pipeline/default_steps", "./template_loader", "./template_resolver", "./directive_metadata", "../annotations/annotations", "../annotations/template", "./shadow_dom_emulation/content_tag", "./shadow_dom_strategy", "./pipeline/compile_step"], function($__export) {
  "use strict";
  var Type,
      isBlank,
      isPresent,
