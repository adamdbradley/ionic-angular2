System.register(["angular2/di", "angular2/src/facade/lang", "angular2/src/facade/dom", "./compiler/compiler", "./compiler/view", "angular2/src/reflection/reflection", "angular2/change_detection", "./compiler/template_loader", "./compiler/template_resolver", "./compiler/directive_metadata_reader", "./compiler/directive_metadata", "angular2/src/facade/collection", "angular2/src/facade/async", "angular2/src/core/zone/vm_turn_zone", "angular2/src/core/life_cycle/life_cycle", "angular2/src/core/compiler/shadow_dom_strategy", "angular2/src/core/compiler/xhr/xhr", "angular2/src/core/compiler/xhr/xhr_impl", "angular2/src/core/events/event_manager", "angular2/src/core/events/hammer_gestures", "angular2/src/di/binding"], function($__export) {
  ...
  return {
    ...
    execute: function() {
      _rootBindings = [bind(Reflector).toValue(reflector), bind(ChangeDetection).toValue(dynamicChangeDetection), Compiler, CompilerCache, TemplateLoader, TemplateResolver, DirectiveMetadataReader, Parser, Lexer, bind(ShadowDomStrategy).toValue(new NativeShadowDomStrategy()), bind(XHR).toValue(new XHRImpl())];
