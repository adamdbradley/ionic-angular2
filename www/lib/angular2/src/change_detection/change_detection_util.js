System.register(["angular2/src/facade/lang", "angular2/src/facade/collection", "./parser/context_with_variable_bindings", "./array_changes", "./keyvalue_changes", "./proto_change_detector", "./exceptions", "./interfaces"], function($__export) {
  "use strict";
  var isPresent,
      isBlank,
      BaseException,
    ...
    execute: function() {
      ...
      ChangeDetectionUtil = $__export("ChangeDetectionUtil", (function() {
        ...
        return ($traceurRuntime.createClass)(ChangeDetectionUtil, {}, {
          ...
          structuralCheck: function(self, context) {
